...
% ¤¤ Opsætning af enheder ¤¤ %
	\newcommand{\enhed}[1]{\hfill\left[\mathrm{ #1}\right]} 	% Skriv \enhed{"din enhed"} og dem bliver rykket til højre
...
\makeevenhead{AAU}{Group 735}{}{\leftmark}					% Definerer lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
...
\makeglossaries
\input{Clean_up/Glossaries}


%%%% COOL EXTRA FEATURES %%%%%
\usepackage{lastpage}
\usepackage{todonotes}
\newcommand{\todoc}[1]{\todo[color=green, author=Christoffer]{#1}}
\graphicspath{{./report/pictures/}}
\newcommand{\todor}[1]{\todo[color=red, author=Read:]{#1}}
\graphicspath{{./report/pictures/}}
\newcommand{\todom}[1]{\todo[color=Yellow, author=Move?:]{#1}}
\usepackage{epstopdf}
