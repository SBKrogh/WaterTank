...
The operating value for the pump flows can be determined by the nonlinear model of the pumps with the available pressure measurements. This is described in detail in \appref{cha:linear_pump2}. 
\\
