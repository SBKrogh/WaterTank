...
\\
The function, $\Upsilon$, defines a quadratic surface. If this surface is convex, then it looks such that in \figref{convexfig}. If the objective function is non-convex, the surface looks such that in \figref{nonconvexfig}. 
