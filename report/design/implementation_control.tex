...
The MPC problem set up to optimize the power consumption of the pumps, developed through \secref{sec:MPC}, has been proved to be convex. In this way, the main feature of this controller is the ability to reduce the power consumption based on the electric price and the WT level. 
