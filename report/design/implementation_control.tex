...
\caption{Input pressures for simulation with input constraint.}
\label{fig:Output_input}
\end{figure}
...
\caption{State pressures for simulation with input constraint.}
\label{fig:Output_input}
\end{figure}
...
\caption{Output pressures for simulation with input constraint.}
\label{fig:Output_input}
\end{figure}
