...
\end{equation}
 ...
 Since A in \eqref{statespace_4} is a constant, due to the tank only having one state, the WT has one time constant. However the unit of A is in $[\frac{m^3}{h}]$ and needs to be convert to seconds. \todo{Convert from $m^3/h$ and see how much it fits compared to the test below - Ignacio}
...
\begin{figure}[H]
\input{report/tikz/Time_constant_Water_Tank2}
