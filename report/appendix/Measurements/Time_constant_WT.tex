...
\end{equation}
 ...
 Since A in \eqref{statespace_4} is a constant, due to the tank only having one state, the WT has one time constant. However the unit of A is in $[\frac{m^3}{h}]$ and needs to be convert to seconds. \todo{Convert from $m^3/h$ and see how much it fits compared to the test below}
...
\todo{change the y axis of the WT measurement}
