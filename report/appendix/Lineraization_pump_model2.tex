...
\centering
\begin{split}
q_{C18} &= 0.761 \hspace{20pt} q_{C25} &= 1.422 \hspace{20pt} q_{C2} &= 1.483 \hspace{20pt} q_{C16} &= 1.474
\end{split}
\end{equation}
...
\centering
	\begin{split}
	G_{C18}(s) &= 0.208 \hspace{20pt} G_{C25}(s) &= 0.528 \hspace{20pt} G_{C2}(s) &= 0.975 \hspace{20pt} G_{C16}(s) &= 0.976
