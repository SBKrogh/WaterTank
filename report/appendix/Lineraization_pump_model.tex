...
To estimate the flow, q, through the pumps, the small signal pressure has to be found. With the relation $\Delta P = \bar{\Delta} P + \hat{\Delta} P$, the small signal deviation, $\hat{\Delta} P$ can be found from measurements, where the $\hat{\omega}$ have been chosen to $0.1 \omega$.  
