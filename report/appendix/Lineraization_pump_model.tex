...
To estimate the flow, q, through the pumps, the small signal pressure has to be found. With the relation $\Delta P = \bar{\Delta} P + \hat{\Delta} P$, the linear small signal deviation, $\hat{\Delta} P$ can be found through measurements, where the $\hat{\omega}$ have been chosen to $\pm 0.05 \omega$.  
...
\todo{Include test procedure and continue form here}
