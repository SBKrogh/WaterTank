...
The notation for bar i going to be denoted as $p_{bar}$, which is equal to $1\cdot p_{bar}[\text{bar}] = \frac{p}{10^5}[\text{Pa}]$. From this we can rewrite \eqref{UnitCon_eq} to 
