...
\end{tabular}
\caption{Table with details about the fittings in the water system. The finttings are not shown in \figref{systemdiagram}. The values are found in \citep{Polypipe,PEPS}.}
