...
In order to verify the state-space model derived in \chapref{LinParamEst} with the physical setup, the estimation of the parameters defined in \secref{estimateParameters}
is carried out.
