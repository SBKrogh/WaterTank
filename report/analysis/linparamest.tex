...
\begin{figure}[H]
  \centering
    \input{report/tikz/Node10_estimation_1.tex}
    \caption{Estimation comparison for node 10.}
\end{figure}

\begin{figure}[H]
   \centering
    \input{report/tikz/Node11_estimation_1.tex}
    \caption{Estimation comparison for node 11.}
\end{figure}

\begin{figure}[H]
   \centering
    \input{report/tikz/Node15_estimation_1.tex}
    \caption{Estimation comparison for node 15.}
\end{figure}

\begin{figure}[H]
   \centering
    \input{report/tikz/Node16_estimation_1.tex}
...
\begin{figure}[H]
   \centering
    \input{report/tikz/WT_estimation_1.tex}
