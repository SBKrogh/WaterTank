...
In addition, the pump equation, see \eqred{eq:PumpModel}, is given by a set of parameters which values are calculated for $[m^3/h]$ flow conditions and [Par] pressure conditions. 
