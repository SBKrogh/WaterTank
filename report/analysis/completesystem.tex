...
\\
The complete model consists of the pipe model, \eqref{CompactValveModel} the valve model, \eqref{eq:PumpModel} the pump model and \eqref{CompleteWTModel} the WT. For the pressure drop across the $k^{th}$ component the following expression can be written: 
