...
\begin{equation}
 \bm{B}\bm{J {B}}^T \bm{\dot{z}} = \bm{M_p} \bm{\hat{z}} + \bm{N_p} \bm{\hat{u}} + \bm{B_o} \Delta \hat{p}_{wt}    
 \label{statespace_1}
\end{equation}
...
\begin{equation}
\Delta \dot{p}_{wt} = (\bm{S}\bm{M_p^{-1}}\bm{B_o}) \Delta \hat{p}_{WT}  + (\bm{S}\bm{M_p^{-1}}\bm{N_p}) \bm{\hat{u}} 
\label{statespace_3}
\end{equation}
...
%
\begin{equation}
  \bm{\hat{y}} = \bm{C_{p,1}} \Delta \hat{p}_{wt} + \bm{D_p} \bm{\hat{u}} 
  \label{outputfinaleq}
\end{equation}
