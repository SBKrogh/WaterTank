...
\\
In this section it is shown how the model describing the network is linearized with the help of Taylor-series.\todo{source}
...
\todo{two letters are not the same}
