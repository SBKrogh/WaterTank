...
Centrifugal pumps are good for this purpose, as the output is steady and consistent. 
...
Because the $a_{h2}$, $a_{h1}$, $a_{h0}$, from the data sheet, is scaled to other units the unit for pressure is here [Bar] and the unit for flow is ${[\frac{m^3}{h}]}$.
