...
The cycle matrix of a directed graph can be expressed with $\pmb{B} = [b_{ij}]$ where $i$ and $j$ denote the chords and edges respectively. 
...
The graph of a hydraulic network assigns two variables to every edge: 
