...
Since exponential functions never cross the zero point, it is reasonable to use linear characteristics in the lower range. The transition from linear to exponential part has to be continuously differentiable and predetermined by $n_{gl}$. \citep{Kallesoe2009} \cite{keller}
