...
\\
		k_{v100} \, e^{(n_{gl} \,(\gamma-1))} \text{,} & \mbox{ if } \gamma \geq \frac{1}{n_{gl}}
...
In the further discussion of the valves or at any places where $\mu$ is mentioned, the input variable is considered as the $OD$. Therefore concerning the notation of the $k^{th}$ valve, it is written as: 
