...
The main reservoir has a volume of 1000 L and the WT a volume of 200 L. A system diagram of the entire test setup, including pipe dimensions, naming and so on, can be seen in \todo{add appendix reference}.