...
The main reservoir has a volume of 1000 L and the WT a volume of 200 L. THe volume of the WT in this report is denoted as $V_t$. A system diagram of the entire test setup, including pipe dimensions, naming and so on, can be seen in \secref{systemdiagram}.
