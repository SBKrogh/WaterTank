...
As can be seen in \eqref{FinalPipeModelCompact}, the flow dynamics of the $k$th pipe is described by $J_k$ which is an analogous parameter as inertia in mechanical systems. Where $J_k$ is a diagonal matrix with zeros for the diagonal elements not related to a pipe, $J = diag(J_i)$.
