...
\todo{Insert here a free-body diagram - Tom}
...
Water flow, q, can be described in terms of water velocity, $v$, and cross sectional 
area, A, resulting in:
...
By dividing the equation with the cross sectional area, A, it can be seen that the equation is depeding on the pressure difference between two endpoints. \todo{Is this paragraph okay? else include the out comment.}
