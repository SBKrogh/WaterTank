...
Assuming the side walls of the WT are vertical,\eqref{Newton_WT} can be rewritten in terms of pressure such as: 
...
In the \eqref{FlowConservation} the volume flow rate ($q$) is equivalent to the current ($I$) in a 
