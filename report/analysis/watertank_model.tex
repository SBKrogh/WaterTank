...
Similarly to the modelling of the other components, the relation between the two dual variables, pressure difference and flow are  derived. The structure of the WT is illustrated in \figref{fig:watertower_sketch}.
...
In \figref{fig:watertower_sketch}, $p_a$ represents the pressure on the surface of the water, therefore it is the atmospheric pressure at all time. $p$ equals to the pressure value on the bottom of the tank. \\
