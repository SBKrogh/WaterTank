...
\todo{VINKEL: I removed a figure, someone should read this and say it's okay.}
...
The WT is connected to the remaining system with three components, a pump, $C_{32}$, and a value on each side. This is shown in \figref{fig:subsys_1}, here the components are shown between $n_3$ and $n_{18}$. 
