...
The WT is connected to the rest of the system with three components, a pump, $C_{32}$, and two valves. This is shown in \figref{fig:subsys_1}, where the components are shown between $n_3$ and $n_{18}$. 
