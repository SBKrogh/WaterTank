...
The sent packets follow the same structure as the received packets, however only one vector of numerical values containing the setpoints is required. The bitcode of the numerical values is copied into an array and the array is sent.
